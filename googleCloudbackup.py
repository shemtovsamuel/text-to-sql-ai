...
Columns:
- note_id (uuid): Unique identifier of the note, primary key, default value gen_random_uuid()
- client_id (uuid): Identifier of the client associated with this note, default value NULL
- note_text (text): Content of the note, default value NULL
- created_by (uuid): Created by user ID, default value auth.uid()
- updated_by (uuid): Updated by user ID, default value auth.uid()
- created_at (timestamptz): Date and time when the record was created, default value now()
- updated_at (timestamptz): Date and time when the record was last updated, default value NULL
- deleted_at (timestamptz): Date and time when the record was deleted, default value NULL
- note_type (int4): Type of the note, default value NULL
...
Table name: order_card_packs
Columns:
- order_id (uuid): Identifier of the order, part of composite primary key
...
Table name: paiement_par_financement
Columns:
- id (int8): Unique identifier, primary key
- order_id (uuid): Identifier of the associated order, part of composite primary key
- client_id (uuid): Identifier of the client, part of composite primary key
- organisme_financier (varchar): Name of the financial organization
- report (float4): Report value
- taux_debiteur_fixe (float4): Debtor rate
- tage_fixe (float4): Fixed rate
- nombre_decheances (int4): Number of due dates
- montant_decheances (float8): Amount of each due date
- periodicite (varchar): Periodicity of payments
- montant_total (numeric): Total amount
- created_at (timestamptz): Date and time when the record was created, default value now()
- updated_at (timestamptz): Date and time when the record was last updated, default value now()

Table name: payments
Columns:
- id (int4): Unique identifier, primary key
- order_id (uuid): Identifier of the associated order
- payment_status (text): Status of the payment, default value 'unpaid'
- payment_date (timestamptz): Date and time of the payment
- signature_status (text): Status of the signature, default value 'pending'
- signature_date (timestamptz): Date and time of the signature
- created_at (timestamptz): Date and time when the record was created, default value now()
- updated_at (timestamptz): Date and time when the record was last updated, default value now()
- deleted_at (timestamptz): Date and time when the record was deleted, default value NULL
- client_id (uuid): Identifier of the client
- document_type (text): Type of document, default value 'devis'
- envelope_id (text): Identifier of the envelope
- ref (int4): Reference number
- invoice_id (int8): Identifier of the invoice
- organization_id (int8): Organization ID, default value '2'::bigint

Table name: permissions
Columns:
- id (uuid): Unique identifier, primary key, default value gen_random_uuid()
- slug (varchar): Slug for the permission, default value NULL
- created_at (timestamptz): Date and time when the record was created, default value now()
- is_system (bool): Indicates if it's a system permission, default value false
- organization_id (int8): Organization ID, default value '2'::bigint
...
Columns:
- id (uuid): Unique identifier, primary key, default value gen_random_uuid()
- description (text): Description of the quote, default value NULL
- client_id (uuid): Identifier of the client associated with this quote, default value NULL
- total_ht (numeric): Total amount excluding tax, default value NULL
- created_at (timestamptz): Date and time when the record was created, default value now()
- deleted_at (timestamptz): Date and time when the record was deleted, default value NULL
- created_by (uuid): Identifier of the user who created the quote, default value auth.uid()

Table name: quotes_products
Columns:
- id (uuid): Unique identifier, primary key, default value gen_random_uuid()
- created_at (timestamptz): Date and time when the record was created, default value now()
- product_id (uuid): Identifier of the product associated with this quote, default value NULL
- pack_id (uuid): Identifier of the pack associated with this quote, default value NULL
- price_ht (numeric): Price excluding tax, default value NULL
...
Table name: subproduct_to_product
Columns:
- id (uuid): Unique identifier of the subproduct-to-product relationship, primary key, default value gen_random_uuid()
- product_id (uuid): ID of the product, default value NULL
- sub_product_id (uuid): ID of the sub-product, default value NULL
- created_at (timestamptz): Date and time when the record was created, default value now()
- updated_at (timestamptz): Date and time when the record was last updated, default value now()
- created_by (uuid): ID of the user who created the record, default value NULL
...
Columns:
- id (uuid): Unique identifier of the user role association, primary key, default value gen_random_uuid()
...
def sql_query_generator(request):
    ...
    try:
        ...
        result = chain.invoke({"request": user_request, "description_tables": DESCRIPTION_TABLES})
